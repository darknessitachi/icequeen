			...
			public void doWith(final Method method) throws IllegalArgumentException, IllegalAccessException {
				...
				Consumer<Event<Object>> handler = new Consumer<Event<Object>>() {
					...
					public void accept(Event<Object> ev) {
						...
						if (!argTypes[0].isAssignableFrom(ev.getClass()) && conversionService.canConvert(ev.getClass(), argTypes[0])) {
				...
				if (!(selObj instanceof Selector)) {
					throw new IllegalArgumentException(selObj + ", referred to by the expression '" + onAnno.selector() + "', is not a Selector");
				}
				if (null == reactorObj) {
			...
			if ("$".equals(name)) {
				return new MethodExecutor() {
					...
					public TypedValue execute(EvaluationContext context, Object target, Object... arguments) throws AccessException {
						if (arguments.length != 1 || null == arguments[0] || !Serializable.class.isAssignableFrom(arguments[0].getClass())) {
							return null;
						}
				...
				return new MethodExecutor() {
					@Override
					public TypedValue execute(EvaluationContext context, Object target, Object... arguments) throws AccessException {
						if (arguments.length != 1 || null == arguments[0] || !Class.class.isAssignableFrom(arguments[0].getClass())) {
							return null;
						}

...
public class FillEvent extends Event
    {
        ...
        public FillEvent(LocalDateTime timeIndex, String symbol, String exchange, int quantity, TransactionDirection direction, double fillCost )
        {
        ...
        public FillEvent(LocalDateTime timeIndex, String symbol, String exchange, int quantity, TransactionDirection direction, double fillCost, double comission )
        {
            this.TimeIndex = timeIndex;
            this.Symbol = symbol;
            this.Exchange = exchange;
        ...
        {
            double fullCost = this.Quantity <= 500 ? Math.max(1.3, 0.013 * this.Quantity) : Math.max(1.3, 0.008 * this.Quantity);
